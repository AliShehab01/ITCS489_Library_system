<?php
// BorrowBook.php
require 'dbconnect.php';          // mysqli $conn to database `library_system`
require_once 'reservations_lib.php'; // <-- queue helpers (fairness + fulfill)
...
<div class="container py-4">
  ...
  <div class="mt-3">
    <small class="text-muted">
      Tip: If a book has no available copies, use the <a href="reservations.php">Reservations</a> page to add users to the queue.  
